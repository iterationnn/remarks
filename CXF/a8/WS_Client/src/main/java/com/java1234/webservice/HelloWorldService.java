 ...
 * 2016-02-22T16:30:07.672+08:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "HelloWorldService", 
                  wsdlLocation = "http://10.10.7.18/helloWorld?wsdl",
...
public class HelloWorldService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.10.7.18/helloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://10.10.7.18/helloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
